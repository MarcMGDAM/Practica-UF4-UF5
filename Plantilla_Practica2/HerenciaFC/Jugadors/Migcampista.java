...
public class Migcampista extends Jugador{
    ...
    public void calcularSouVariable() {
        ...
        souFinal = getSou_base() + (assistencies_gol * incentiu_assitenciagols) + (pilotes_recuperades + incentiu_pilotesrecuperades);
    ...
    public Migcampista altaMigcampista(){
        ...
        Migcampista m = new Migcampista("11372054T", "Pedro ", "González ", "López", LocalDate.parse("2002-11-25"), 64209007, "pedro@gmail.com", "GUYI9672814070", 30000, true, 129, 32);
        return m;
