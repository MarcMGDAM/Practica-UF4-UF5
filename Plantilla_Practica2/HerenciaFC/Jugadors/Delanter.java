...
public class Delanter extends Jugador{
    ...
    public void calcularSouVariable() {
        ...
        souFinal = getSou_base() + (gols_marcats * incentiu_golsMarcats) + (pilotes_Recuperades + incentiu_pilotesRecuperades);
    ...
    public Delanter altaDelanter(){
        ...
        Delanter d = new Delanter("32980015H", "Cristiano", "Ronaldo", "Aveiro", LocalDate.parse("1985-02-05"), 633789275, "luigi@gmail.com", "BICH4047814111", 90000, true, 877, 9);
        return d;
