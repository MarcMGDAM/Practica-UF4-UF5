...
public class Defensa extends Jugador{
    ...
    public void calcularSouVariable() {
        ...
        souFinal = getSou_base() + (atacs_aturats * incentiu_atacsAturats) + (pilotes_recuperades + incentiu_pilotesRecuperades);
    ...
    public Defensa altaDefensa(){
        ...
        Defensa d = new Defensa("40024887F", "Gerard ", "Piqué ", "Bernabeu ", LocalDate.parse("1987-02-02"), 664538990, "gerard@gmail.com", "GEPI9937814123", 25000, true, 98, 13);
        return d;
