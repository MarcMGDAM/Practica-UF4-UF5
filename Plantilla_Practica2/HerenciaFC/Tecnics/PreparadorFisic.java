...
public class PreparadorFisic extends Tecnic{
    ...
    public void calcularSouVariable() {
        ...
        souFinal = getSou_base() + (getAnys_exp() * incentiu);
    }
    ...
    public PreparadorFisic altaPreparadorFisic(){
        ...
        PreparadorFisic p = new PreparadorFisic("93748557Q", "Josep", "Camps", "Fuste", LocalDate.parse("1988-01-01"), 664589001, "josep@gmail.com", "PESE1739911230", 1100, 8);
        return p;
